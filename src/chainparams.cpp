...
{
    const char* pszTimestamp = "CNN Updated 0506 GMT (1306 HKT) May 10, 2021 China blames the US for hyping fears of uncontrolled rocket reentry as space race heats up";
    const CScript genesisOutputScript = CScript() << ParseHex("069284710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
    ...
    CMainParams() {
      ...
      //  consensus.BIP66Height = 811879; // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
       ...
       //  consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1517356801; // January 31st, 2018
        ...
        genesis = CreateGenesisBlock(1620626790, 2001030898, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8a34580874dbe787098683fb2b131adf5d723e2f9561d1ec1f28f19fa39e9491"));
        assert(genesis.hashMerkleRoot == uint256S("0xb23d6ceff10e1623f3450004ad1f66c8b2d1ff6a42ff13ece640f3a24c51d026"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("18.196.35.69", "3.66.225.203 ", true));
         //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        // vSeeds.push_back(CDNSSeedData("vcashpaytools.com", "dnsseed.vcashpaytools.com"));
         //vSeeds.push_back(CDNSSeedData("vcashpaypool.org", "dnsseed.vcashpaypool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x8a34580874dbe787098683fb2b131adf5d723e2f9561d1ec1f28f19fa39e9491"))
        ...
        chainTxData = ChainTxData{
            ...
            1620626790, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
       ...
       //  consensus.BIP34Hash = uint256S("8075c771ed8b495ffd943980a95f702ab34fce3c8c54e379548bda33cc8c0573");
        ...
        vSeeds.push_back(CDNSSeedData("18.196.35.69", "3.66.225.203"));
      //  vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.vcashpay.loshan.co.uk", true));
      //  vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed-testnet.thrasher.io", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x65ae3b821547a1fd4ab5d338414b213afb576aa57fb2b2acac2fd444dddd36f5")),
        };
...
public:
    ...
    //    consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 999999999999ULL;
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xc12baece7273b4327bc84c41a37d46a0b51a201b3b21e88182250093096e1b2a"))
        };
