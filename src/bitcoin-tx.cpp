...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s vcashpay-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  vcashpay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vcashpay transaction") + "\n" +
              "  vcashpay-tx [options] -create [commands]   " + _("Create hex-encoded vcashpay transaction") + "\n" +
              "\n";
