...
const char * const BITCOIN_CONF_FILENAME = "vcashpay.conf";
const char * const BITCOIN_PID_FILENAME = "vcashpay.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "VcashPay";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/VcashPay";
#else
    // Unix
    return pathRet / ".vcashpay";
#endif
#endif
}
