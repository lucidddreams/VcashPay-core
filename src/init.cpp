...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/vcashpay-project/vcashpay>";
    const std::string URL_WEBSITE = "<https://vcashpay.org>";
