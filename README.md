...
10. Don't forget to make your nodes forge / and add peers
11. Run sudo crontab -e
12. Add this 45 2 * * 6 /usr/bin/certbot renew --dry-run --renew-hook "service apache2 restart" and save
